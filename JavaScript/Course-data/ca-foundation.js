...
const btnCAPaperFoundation = document.getElementById("ca-paper-foundation");
const btnCAEntryFoundation = document.getElementById("ca-entry-foundation");
const btnCAJobFoundation = document.getElementById("ca-job-foundation");
const btnCAInterFoundation = document.getElementById("ca-inter-foundation");
const tabContent = document.querySelector(".tab-content");
const list = document.createElement("ul");

tabContent.append(list);
function btnHighlighted(btn) {
  btnCAPaperFoundation.className = "";
  btnCAEntryFoundation.className = "";
  btnCAJobFoundation.className = "";
  btnCAInterFoundation.className = "";
...
function handleClick(e) {
  btnHighlighted(e.target);
   if (e.target.id === "ca-paper-foundation") {
    displayContent(papersCA[0]);
  } else if (e.target.id === "ca-entry-foundation") {
    displayContent(entryRoutesCA[0]);
  } else if (e.target.id === "ca-job-foundation") {
    displayContent(jobRolesCA[0]);
  } else if (e.target.id === "ca-inter-foundation") {
    displayContent(jobRolesCA[1]);
  }
}

btnCAPaperFoundation.addEventListener("click", handleClick);
btnCAEntryFoundation.addEventListener("click", handleClick);
btnCAJobFoundation.addEventListener("click", handleClick);
btnCAInterFoundation.addEventListener("click", handleClick);
